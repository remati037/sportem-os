...
import { createCategory, deleteCategory, updateCategory, type CatalogActionState } from "./actions";
...
export function CategoryDialog({
  ...
  function run(fn: () => Promise<CatalogActionState>, onOk?: () => void) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Dodajte, preimenujte ili obrišite kategorije.</DialogDescription>
        </DialogHeader>
